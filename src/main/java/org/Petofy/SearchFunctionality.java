...
public class SearchFunctionality extends AndroidActions {
	...
	// Toast message
	// @AndroidFindBy(xpath="//android.widget.Toast[@text=\"Please Select Nature of
	// Visit\"]")
	...
	public void clickSearchbox() {
		...
		try {
			...
			waitUtils.waitForClickability(searchbox).click();
	...
	public void typePetName(String typePetname) {
		...
		try {
			...
			waitUtils.waitForClickability(typepetName).sendKeys(typePetname);
	...
	public void clickSearchIcon() {
		...
		try {
			...
			waitUtils.waitForClickability(searchIcon).click();
	...
	public void addClinicButton() {
		...
		try {
			...
			waitUtils.waitForClickability(petClinicVisit).click();
			// searchbox.sendKeys(searchIcon);
		} catch (TimeoutException e) {
	...
	public void ClickAddclinicVisit() {
		...
		try {
			...
			waitUtils.waitForClickability(clinicVisitOption).click();
			// searchbox.sendKeys(searchIcon);
		} catch (TimeoutException e) {
	...
	public void clickOnNextbutton() {
		...
		try {
			...
			waitUtils.waitForClickability(nextButton).click();
	...
	public void selectNatureOfVisitOption() {
		...
		try {
			...
			waitUtils.waitForClickability(selectVisitOption).click();
	...
	public void selectImmunizationOption() {
		...
		try {
			...
			waitUtils.waitForClickability(ImmunizationOption).click();
