...
public class RegisterPet extends AndroidActions {
	...
	// back button com.cynoteck.petofyOPHR:id/back_arrow_CV//
	...
	public void clickPlusIcon() throws InterruptedException {
		...
		try {
			...
			WebElement plusIconButton = waitUtils.waitForClickability(PlusIcon);
	...
	// ********************Test that Pet Category Option is visible or
	// not******************************************//
	public void checkPetCategoryText() {
		...
		try {
			...
			WebElement element = waitUtils.waitForVisibility(
					By.id("com.cynoteck.petofyOPHR:id/pet_category_TV"));
	...
	// ************************Test that Select Pet Type text should be
	// visible*****************************************//
	...
	// } else {
	// System.out.println("❌ Extracted text does not match. Found: " +
	// extractedText);
	// }
	// } catch (TimeoutException e) {
	...
	public void checkGender() {
		...
		try {
			...
			// WebElement element =
			// waitUtils.waitForVisibility(By.id("com.cynoteck.petofyOPHR:id/pet_gender_TV"));
			WebElement element = waitUtils.waitForClickability(By.id("com.cynoteck.petofyOPHR:id/pet_gender_TV"));
	...
	public void checkMale() {
		...
		try {
			...
			WebElement element = waitUtils.waitForVisibility(By.id("com.cynoteck.petofyOPHR:id/maleRB"));
	...
	// Test functionality that Female option should be visible on While selecting
	// Gender
	public void checFemale() {
		...
		try {
			...
			WebElement element = waitUtils.waitForVisibility(By.id("com.cynoteck.petofyOPHR:id/femaleRB"));
	...
	public void ChooseGender() throws InterruptedException {
		...
		try {
			...
			waitUtils.waitForClickability(selectGender).click();
	...
	public void ClickBreedDropdown() throws InterruptedException {
		...
		try {
			...
			waitUtils.waitForClickability(petbreedDropdown).click();
	...
	public void selectBreedName() throws InterruptedException {
		...
		try {
			...
			waitUtils.waitForClickability(SelectPetBreed).click();
		} catch (TimeoutException e) {
	...
	public void petName(String petname) {
		...
		try {
			...
			WebElement typePetName = waitUtils.waitForClickability(TypePetName);
	...
	public void checkDateOfBirth() {
		...
		try {
			...
			WebElement element = waitUtils.waitForVisibility(By.id("com.cynoteck.petofyOPHR:id/pet_dob_TV"));
			// Extract text from the element
			String extractedText = element.getText();
			System.out.println("Extracted text: " + extractedText);
	...
	public void DOBofPet() throws InterruptedException {
		...
		try {
			...
			waitUtils.waitForClickability(petDOB).click();
	...
	public void selectDaydropdown() {
		...
		try {
			...
			waitUtils.waitForClickability(dateofDob).click();
	...
	public void typeDayofDOB() throws InterruptedException {
		...
		try {
			...
			waitUtils.waitForClickability(selectweek).click();
	...
	public void clickagebox(int index) throws InterruptedException {
		...
		try {
			...
			waitUtils.waitForClickability(clickAgeplaceholder).click();
	...
	public void clickpetcolordropdown() throws InterruptedException {
		...
		try {
			...
			waitUtils.waitForClickability(petColordropdown).click();
	...
	public void selectPetcolorDropdown() throws InterruptedException {
		...
		try {
			...
			waitUtils.waitForClickability(selectpetColor).click();
		} catch (TimeoutException e) {
	...
	public void checkPetParent() {
		...
		try {
			...
			WebElement element = waitUtils.waitForVisibility(By.id("com.cynoteck.petofyOPHR:id/pet_patent_TV"));
			// Extract text from the element
			String extractedText = element.getText();
			System.out.println("Extracted text: " + extractedText);
	...
	public void petParentname(String petparent) throws InterruptedException {
		...
		try {
			...
			// parentname.sendKeys(petparent);
			WebElement petParentName = waitUtils.waitForClickability(parentname);
			petParentName.sendKeys(petparent);
		} catch (TimeoutException e) {
	...
	public void enterWhatsappNumber(String mobileNo) throws InterruptedException {
		...
		try {
			...
			// wtsappNumber.sendKeys(mobileNo);
			WebElement whatsAppNumber = waitUtils.waitForClickability(wtsappNumber);
			whatsAppNumber.sendKeys(mobileNo);
		} catch (TimeoutException e) {
	...
	public void checkAlternative() {
		...
		try {
			...
			WebElement element = waitUtils
					.waitForVisibility(By.id("com.cynoteck.petofyOPHR:id/pet_Alternatecontact_TV"));
	...
	public void addAlternatenum(String alternatenum) {
		...
		try {
			...
			WebElement alternateNumber = waitUtils.waitForClickability(alternateno);
			alternateNumber.sendKeys(alternatenum);
		} catch (TimeoutException e) {
			System.out.println("Timed out waiting for Pet whats app number selection");
		}
	...
	public void checkEmailAddress() {
		...
		try {
			...
			WebElement element = waitUtils.waitForVisibility(By.id("com.cynoteck.petofyOPHR:id/pet_email_TV"));
	...
	public void fillEmail(String email) throws InterruptedException {
		...
		try {
			...
			// emailfield.sendKeys(email);
			WebElement emailField = waitUtils.waitForClickability(emailfield);
			emailField.sendKeys(email);
		} catch (TimeoutException e) {
	...
	public void checkAddress() {
		...
		try {
			...
			WebElement element = waitUtils.waitForVisibility(By.id("com.cynoteck.petofyOPHR:id/pet_address_TV"));
	...
	public void fillAddress(String address) throws InterruptedException {
		...
		try {
			...
			WebElement fillAddressField = waitUtils.waitForClickability(addressField);
			fillAddressField.sendKeys(address);
		} catch (TimeoutException e) {
	...
	// System.out.println("✅ Address is visible.");
	// } else {
	// System.out.println("❌ Extracted text Address does not match. Found: " +
	// extractedText);
	// }
	// } catch (TimeoutException e) {
	// System.out.println("⏳ Address option not found within timeout.");
	...
	public void checkMyPetsOption() {
		try {
			// WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
			// WebElement myPetsElement =
			// wait.until(ExpectedConditions.elementToBeClickable(
			// AppiumBy.androidUIAutomator("new UiSelector().text(\"My Pets\")")));
			// myPetsElement.click();
			WebElement myPetsElement = waitUtils
					.waitForClickability(AppiumBy.androidUIAutomator("new UiSelector().text(\"My Pets\")"));
			myPetsElement.click();
	...
	// System.out.println("Element with ID: " + elementId + " is visible and
	// clickable.");
	// }
	// } catch (TimeoutException e) {
	// System.out.println("Element with ID: " + elementId + " is NOT clickable
...
// new UiSelector().className("android.widget.ImageView").instance(0)//-android
// uiautomator
